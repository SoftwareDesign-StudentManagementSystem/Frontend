import { Attendance, SemesterType, AddAttendanceProps, UpdateAttendanceProps } from "../types/attendance";
...
export declare const getFilteredMyAttendance: (year: number, semester: SemesterType) => Promise<Attendance[]>;
export declare const getFilteredStudentAttendance: (studentId: number, year: number, semester: SemesterType) => Promise<Attendance[]>;
